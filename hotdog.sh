...
# Download manifest
git clone https://github.com/shipukacapri/hotdog_local_manifest --depth 1 -b inf-qp2 .repo/local_manifests

# Clean previous sources
rm -rf device/oneplus/hotdog
rm -rf device/oneplus/sm8150-common
rm -rf kernel/oneplus/sm8150
rm -rf vendor/oneplus/hotdog
...
rm -rf out/target/product/hotdog
...
lunch infinity_hotdog-userdebug
