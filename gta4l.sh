...
# Download manifest
git clone https://github.com/shipukacapri/gta4l_local_manifest --depth 1 -b inf-qp2 .repo/local_manifests

# Clean previous sources
rm -rf device/samsung/gta4l
...
rm -rf out/target/product/capri
...
lunch infinity_gta4l-userdebug
